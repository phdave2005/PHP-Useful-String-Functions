...
function html_wrap($str, $tag, $attributes) {
	...
	if (is_array($str) || is_null($str)) {
	    ...
	    throw new Exception("The second argument does not represent a valid html tag");	
	} else if (!is_array($attributes)) {
	    throw new Exception("The third argument must be an array of attributes");	
	} else {
